    ...
    <form action="{{url('admin/article/'.$field->art_id)}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    @if($field->art_love == 1)
                    <input type="radio" class="sm" name="art_love" value="1" checked>是
                    <input type="radio" class="sm" name="art_love" value="0">否
                        @else
                        <input type="radio" class="sm" name="art_love" value="1">是
                        <input type="radio" class="sm" name="art_love" value="0" checked>否
                    @endif
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <th></th>
                <td>
                    <img style="max-width: 350px; max-height:100px;" src="../../../{{$field->art_thumb}}">

                    <input type="hidden" size="50" name="art_thumb2" value="{{$field->art_thumb}}">
                </td>
            </tr>
            @endif
            <tr>
